...
class AddCouponReciverVC: BasicVC, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        self.delegate?.onMemberViewClicked(reciver: CouponReciverRequest(id: members![indexPath.row].id, name: members![indexPath.row].name, username: members![indexPath.row].username, image: members![indexPath.row].image))
